    ...
    <header class="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        ...
                        <a href="./about.php" class="font-medium rounded-md px-3 py-2 text-sm text-blue-900">À quoi sert ce site ?</a>
                        </div>
                    </div>
                </div>
        ...
        <div id="mobile-menu" class="sm:hidden hidden">
            <div class="space-y-1 px-2 pt-2 pb-3">
                <a href="./about.php" class="block rounded-md px-3 py-2 text-base font-medium text-blue-800">À quoi sert ce site ?</a>
