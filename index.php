        ...
        <nav class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                    <button id="menu-btn" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        ...
                        <a href="#" class="font-medium rounded-md px-3 py-2 text-sm hover:text-blue-900">À quoi sert ce site ?</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-black hover:text-blue-900">Se connecter</a>
                    <a href="#" class="rounded-full -md bg-blue-800 hover:bg-blue-900 px-3 py-2 text-sm font-medium text-white">S'inscrire</a>
                </div>
            </div>
        </nav>
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-center gap-8">
                        <div class="text-center md:text-left">
                            ...
                            <div class="flex flex-col md:flex-row gap-4">
                                <a href="#" class="bg-blue-800 text-white py-4 px-12 rounded-full hover:bg-blue-900">S'inscrire</a>
                                <a href="#" class="text-black py-4 px-12 rounded-full hover:text-blue-900">Déjà inscrit ? Se connecter</a>
                            </div>
                        </div>
                        <div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16 text-center">
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                    <dd class="order-first text-5xl font-semibold tracking-tight text-gray-900 ">24</dd>
